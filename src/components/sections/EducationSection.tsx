          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto">
            {education.map((edu, index) => (
              <motion.div
                ...
                whileInView={{ opacity: 1, y: 0 }}
                transition={{ duration: 0.5, delay: index * 0.1 }}
                className="bg-card backdrop-blur-sm rounded-xl p-6 border border-border hover:border-purple-400/50 transition-all"
              >
          ...
          <div className="space-y-8 max-w-4xl mx-auto">
            {articles.map((article, index) => (
              <motion.div
                ...
                className="bg-card backdrop-blur-sm rounded-xl p-6 border border-border hover:border-purple-400/50 transition-all group"
              >
